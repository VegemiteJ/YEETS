...
public class JumpTest extends TestCase {
  ...
  public void testManyJumps() {
    Individual i = new Individual(new ArrayList<>(original));
    m.run(i,
        new ArrayList<>(Arrays.asList(new IntegerPair(7, 0), new IntegerPair(7, 1),
            new IntegerPair(7, 2), new IntegerPair(7, 3), new IntegerPair(7, 4),
            new IntegerPair(7, 5), new IntegerPair(7, 6))));
    // Expect {1,2,3,4,5,6,7,8}
