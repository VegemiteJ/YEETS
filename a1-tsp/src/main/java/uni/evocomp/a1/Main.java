...
public class Main {
  ...
  public static void benchmark(String testName, String propertiesFileName, int populationSize,
    ...
    BenchmarkStatsTracker bst =
        new BenchmarkStatsTracker(
            problem.getName() + "_"
                + selectParents.getClass().getSimpleName() + "_"
                + recombine.getClass().getSimpleName() + "_"
                + mutate.getClass().getSimpleName() + "_"
                + selectSurvivors.getClass().getSimpleName() + "_"
                + ".bst",
            problem);
